...
const RegistrationReceive = () => {
  const useStyles = (0,_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_6__.makeStyles)(theme => (0,_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_6__.createStyles)({
    root: {
      "& > *": {
  ...
  const donationRequestToApi = async () => {
    const response = await axios__WEBPACK_IMPORTED_MODULE_5___default().post('/api/donation/orderVerification', {
      donationRequestToCreate
    });
    ...
    if (response.data.length > 0) {
      ...
      const registrationResponse = await axios__WEBPACK_IMPORTED_MODULE_5___default().post('/api/donation/orderRegistration', {
        donationRequestToCreate
      });
